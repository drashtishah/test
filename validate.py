from config import DATA_FOLDER, NORMAL_R1, NORMAL_R2, TUMOR_R1, TUMOR_R2, METHYLATION_CSV_FILE
import os

# Check if files exist in the right location
all_files = [METHYLATION_CSV_FILE, NORMAL_R1, NORMAL_R2, TUMOR_R1, TUMOR_R2]
